...
{
	public partial class DataQueryFilter : FilterControl
	{
		public string Label
		{ get; set; }
		...
		{
			ValueDataSource.SelectCommand = DataQuery;
			...
			Value.DataValueField = DataValueField ?? DataTextField;
			Value.DataTextField = DataTextField ?? DataValueField;
