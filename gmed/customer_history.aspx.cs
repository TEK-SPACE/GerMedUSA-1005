...
namespace AspDotNetStorefrontAdmin
{
	...
	public partial class customer_history : AspDotNetStorefront.Admin.AdminPageBase
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			var targetCustomerId = CommonLogic.QueryStringUSInt("CustomerID");
			var deleteRecurringOrderId = CommonLogic.QueryStringUSInt("DeleteID");

			if (targetCustomerId == 0 && deleteRecurringOrderId == 0)
			{
